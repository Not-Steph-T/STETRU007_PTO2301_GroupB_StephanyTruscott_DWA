import { authors, books } from "./data.js"; // Import your data and constants
...
class BookPreview extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.button.addEventListener("click", (e) => {
      ...
      // Fetch data from attributes and set them to the component & the shadow DOM
      ...
      if (active) {
        ...
        this.shadowRoot.querySelector("[data-list-title]").innerText =
          active.title;
